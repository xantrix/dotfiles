...
# need to be installed (git clone) in ${ZSH_CUSTOM:-${ZSH:-~/.oh-my-zsh}/custom}/plugins/
...
# ln -s /opt/homebrew/opt/kubectx/share/zsh/site-functions/_kubectx ~/.oh-my-zsh/completions/_kubectx
# ln -s /opt/homebrew/opt/kubectx/share/zsh/site-functions/_kubens ~/.oh-my-zsh/completions/_kubens
...
# uncomment POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND https://github.com/romkatv/powerlevel10k#show-on-command
...
# for interactive history use https://formulae.brew.sh/formula/fzf and generate the keybindings
# this should be after oh-my-zsh.sh
[ -f ~/.fzf.zsh ] && source ~/.fzf.zsh

# How to list current bindkeys
...
if [ -f '/Users/xan/google-cloud-sdk/path.zsh.inc' ]; then . '/Users/xan/google-cloud-sdk/path.zsh.inc'; fi

# The next line enables shell command completion for gcloud.
if [ -f '/Users/xan/google-cloud-sdk/completion.zsh.inc' ]; then . '/Users/xan/google-cloud-sdk/completion.zsh.inc'; fi
